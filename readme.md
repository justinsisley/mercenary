...
With Mercenary configured, let's start adding some UI code. In this tutorial, you'll need your terminal and a text editor.

1. Start by creating a __client__ directory at the root of your project: `mkdir client`. Mercenary expects your UI code to live in this directory.
...
> __NOTE:__ If you haven't already, take a moment to look at your project's __package.json__ file. Mercenary has automatically added its commands to your npm scripts.
...
Mercenary uses both webpack-dev-server and Express.js during development. The Express.js server is also used in production mode to handle the serving and caching of static assets, and to handle your local API.
...
Mercenary provides two API configuration options:
...
Mercenary also supports deployment via Docker, and you can produce a __Dockerfile__ and __.dockerignore__ file by running: `npm run docker`.
